% This in implementation of ALGORITHM: ACCURACY ENHANCED RANDOMIZED SVD (WITH ORTHONORMALIZATION) from P.-G. Martinsson. Randomized Methods for Matrix Computations, 2019
function [U,D,V,G] = AEORandSVD(A,k,p,q)
%Input:
